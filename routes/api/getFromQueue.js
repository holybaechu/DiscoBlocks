...
router.get('/', async function(req, res) {
    ...
    if (ipChecker(req.headers['x-forwarded-for'] || req.socket.remoteAddress) != true){console.log('8'); res.status(400).json({success: false, errors: [{message: "This ip is not seems to be allowed to access this api."}]}); return;}
